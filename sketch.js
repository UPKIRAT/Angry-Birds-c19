...
function setup(){
    ...
    box7 = new Box(700,320,60,60);
    box8 = new Box(620,320,60,60);
    box9 = new Box(700,260,60,60);
    box10 = new Box(620,260,60,60);
    box11 = new Box(700,180,60,60);
    box12 = new Box(620,180,60,60);

    box15 = new Box(700,100,60,60);
    box16 = new Box(620,100,60,60);

    box13 = new Box2(700,20,60,60);
    box14 = new Box2(620,20,60,60);
...
function keyPressed(){
    if(keyCode === 32){
        Matter.Body.setPosition(bird.body, {x: 200, y: 270});
        bird.trajectory = [];
...
function keyPressed2(){
    if(keyCode === 65){
       bird.image = loadImage("sprites/aaryan.png")
       pig1.image = loadImage("sprites/Picture1.png");
       pig2.image = loadImage("sprites/Picture2.png");
       pig3.image = loadImage("sprites/Picture3.png");
    }
}
...
function keyPressed3(){
    if(keyCode === 77){
       bird.image = loadImage("sprites/Picture1.png")
       pig1.image = loadImage("sprites/aaryan.png");
       pig2.image = loadImage("sprites/Picture2.png");
       pig3.image = loadImage("sprites/Picture3.png");
    }
}
...
function keyPressed4(){
    if(keyCode === 82){
       bird.image = loadImage("sprites/Picture3.png")
       pig1.image = loadImage("sprites/Picture1.png");
       pig2.image = loadImage("sprites/Picture2.png");
       pig3.image = loadImage("sprites/aaryan.png");
    }
}
